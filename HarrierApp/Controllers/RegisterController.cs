...
namespace HarrierApp.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public JsonResult SaveData(UserAuthModel user)
        {
            try
            {
                user.IsValid = false;
            ...
            catch(Exception ex)
            {
                ...
                return Json("An error occurred while saving data." , JsonRequestBehavior.AllowGet);
            }
        }


        public JsonResult CheckValidUser(UserAuthModel user)
        {
            try
            {
                string result = "Fail";
            ...
            {
                Console.WriteLine($"Exception: {ex.Message}");
                return Json("An error occurred while validating user." , JsonRequestBehavior.AllowGet);
            }
        }
